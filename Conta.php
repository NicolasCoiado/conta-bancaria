<?php //Author: Nicolas Coiado;
    class Conta{ //Criando a classe Conta;
        ...
        public function depositar($valorDeposito){  //Criando método para realizar o depósito;
            $novoSaldo = $this->getSaldo() + $valorDeposito; 
            return $this->setSaldo($novoSaldo);
        }
        public function sacar($valorDeposito){ //Criando método para realizar o saque;
            $novoSaldo = $this->getSaldo() - $valorDeposito;
            return $this->setSaldo($novoSaldo);
        }
        public function transferir($valorDeposito){ //Criando método para realizar a transferência;
            $novoSaldo = $this->getSaldo() - $valorDeposito;
            return $this->setSaldo($novoSaldo);
        }
    }
